 ...
 */
public class GameOneTimeRunMT implements Possession{
     ...
     * @param awayTeam
     */
    public GameOneTimeRunMT(Team homeTeam, Team awayTeam){
    ...
    public static void main(String[] args) {
        ...
        GameOneTimeRunMT game = new GameOneTimeRunMT(heat, bucks);
